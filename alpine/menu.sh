...
BASE_URL="https://ghfast.top/https://raw.githubusercontent.com/dingdang66686/sbshell/refs/heads/main/alpine"
...
setup_alias() {
    ...
    if [ ! -f /usr/local/bin/sb ]; then
        echo -e '#!/bin/bash\nbash /etc/sing-box/scripts/menu.sh "$@"' | tee /usr/local/bin/sb >/dev/null
